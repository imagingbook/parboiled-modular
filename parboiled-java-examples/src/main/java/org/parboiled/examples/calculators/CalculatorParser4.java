...
public class CalculatorParser4 extends CalculatorParser<CalculatorParser3.CalcNode> {
    ...
    public Rule OperatorRule(Rule subRule, Rule operatorRule) {
        ...
        return Sequence(
                ...
                ZeroOrMore(
                        ...
                        subRule,
                        push(new CalculatorParser3.CalcNode(op.get(), pop(1), pop()))
                )
        );
    }
    ...
    public Rule SquareRoot() {
        return Sequence("SQRT", Parens(), push(new CalculatorParser3.CalcNode('R', pop(), null)));
    }
    ...
    public Rule Number() {
        return Sequence(
                ...
                push(new CalculatorParser3.CalcNode(Double.parseDouble(matchOrDefault("0")))),
                WhiteSpace()
        );
    }
