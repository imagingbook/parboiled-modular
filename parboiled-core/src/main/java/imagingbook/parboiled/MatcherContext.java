...
import imagingbook.parboiled.errors.BasicParseError;
...
import imagingbook.parboiled.matchers.MatcherUtils;
...
import imagingbook.parboiled.support.MatcherPosition;
 ...
 * <p>The parsing process works as following:
...
public class MatcherContext<V> implements Context<V> {
    ...
    public MatcherContext(InputBuffer inputBuffer, ValueStack<V> valueStack, List<ParseError> parseErrors,
        ...
        this(Preconditions.checkArgNotNull(inputBuffer, "inputBuffer"), Preconditions.checkArgNotNull(valueStack, "valueStack"),
                Preconditions.checkArgNotNull(parseErrors, "parseErrors"), Preconditions.checkArgNotNull(matchHandler, "matchHandler"),
    ...
    private void checkActionContext() {
        ...
        Checks.ensure(MatcherUtils.unwrap(matcher) instanceof SequenceMatcher && intTag > 0 &&
    ...
    public boolean runMatcher() {
        try {
            ...
            throw new ParserRuntimeException(e,
                    ErrorUtils.printParseError(new BasicParseError(inputBuffer, currentIndex,
