...
package imagingbook.parboiled.common;
...
public final class Utils {
    ...
    public static <T> T[] arrayOf(T firstElement, T... moreElements) {
        Preconditions.checkArgNotNull(moreElements, "moreElements");
    ...
    public static <T> T[] arrayOf(T[] firstElements, T lastElement) {
        Preconditions.checkArgNotNull(firstElements, "firstElements");
    ...
    public static List<Class<?>> getTypeArguments(Class<?> base, Class<?> implementation) {
        Preconditions.checkArgNotNull(base, "base");
        Preconditions.checkArgNotNull(implementation, "implementation");
    ...
    public static boolean isBoxedType(Class<?> primitive, Class<?> boxed) {
        return (primitive.equals(boolean.class) && boxed.equals(Boolean.class)) ||
               ...
               (primitive.equals(double.class) && boxed.equals(Double.class)) ||
               (primitive.equals(float.class) && boxed.equals(Float.class)) ||
               (primitive.equals(int.class) && boxed.equals(Integer.class)) ||
               (primitive.equals(long.class) && boxed.equals(Long.class)) ||
               (primitive.equals(short.class) && boxed.equals(Short.class)) ||
