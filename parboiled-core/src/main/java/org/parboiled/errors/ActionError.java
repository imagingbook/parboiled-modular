...
public class ActionError extends BasicParseError {
    ...
    public ActionError(InputBuffer inputBuffer, int errorIndex, String errorMessage,
        ...
        super(Preconditions.checkArgNotNull(inputBuffer, "inputBuffer"), errorIndex, errorMessage);
        this.errorPath = Preconditions.checkArgNotNull(errorPath, "errorPath");
        this.actionException = Preconditions.checkArgNotNull(actionException, "actionException");
    }
