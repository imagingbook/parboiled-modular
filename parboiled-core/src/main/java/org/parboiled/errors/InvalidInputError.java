...
public class InvalidInputError extends BasicParseError {
    ...
    public InvalidInputError(InputBuffer inputBuffer, int startIndex,
        ...
        super(Preconditions.checkArgNotNull(inputBuffer, "inputBuffer"), startIndex, errorMessage);
        this.failedMatchers = Preconditions.checkArgNotNull(failedMatchers, "failedMatchers");
    }
