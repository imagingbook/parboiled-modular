...
public class RuleMethodRewriterTest extends TransformationTest {
    ...
    public void testRuleMethodRewriting() throws Exception {
        Assert.assertEquals(AsmTestUtils.getMethodInstructionList(processMethod("RuleWithIndirectImplicitAction", processors)), "" +
        ...
        Assert.assertEquals(AsmTestUtils.getMethodInstructionList(processMethod("RuleWithComplexActionSetup", processors)), "" +
